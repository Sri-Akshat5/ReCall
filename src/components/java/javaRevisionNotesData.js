...
export const JAVA_REVISION_SECTIONS = [
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "Executes bytecode on target CPU"
            ],
            [
              "Java Runtime Environment",
              "JRE",
              "JVM + Java Base Class Libraries",
              "Runs pre-compiled Java applications"
            ],
            [
              "Java Development Kit",
              "JDK",
              "JRE + javac, jdb, profilers",
              "Compiles and builds Java software"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Because source code compiles into platform-neutral Bytecode (.class files) executed by OS-specific JVM implementations."
        },
        {
          "q": "Can static methods call non-static instance methods directly?",
          "a": "No. Static methods execute without an instance context ('this' pointer), so accessing non-static methods requires an explicit object reference."
        }
      ]
    }
  },
  {
    ...
    "diagramType": "oop-hierarchy",
    "detailedContent": {
      "introduction": "Object-Oriented Programming (OOP) is a design paradigm centered around Objects containing state and behavior. Java structures enterprise code through 4 core pillars: Encapsulation, Abstraction, Inheritance, and Polymorphism, allowing scalable and modular application architectures.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              ...
              "Same name, EXACT SAME parameters"
            ],
            [
              "Private/Static",
              "Can overload static/private methods",
              "Cannot override static/private methods"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          ...
          "a": "To prevent the Diamond Problem—ambiguity when two parent classes define the exact same method signature."
        },
        {
          "q": "What is Covariant Return Type in Java?",
          "a": "When overriding a method, the subclass method can return a subtype of the return type declared in the parent method."
        }
      ]
    }
  },
  {
    ...
    "subtitle": "String Constant Pool (SCP), Immutability, StringBuilder vs StringBuffer, and Text Blocks",
    "summary": "Deep dive into how Java manages text memory, string literal pooling, and byte[] compact strings.",
    "diagramType": "string-pool-memory",
    "detailedContent": {
      "introduction": "In Java, java.lang.String represents immutable sequence of characters. Because strings represent up to 40% of memory in enterprise workloads, the JVM heavily optimizes text memory through the String Constant Pool (SCP) and Java 9+ Compact Strings.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Up to 2 objects: one in the String Constant Pool (if absent), and one on the general Heap."
        },
        {
          "q": "What is String interning?",
          "a": "s.intern() returns the canonical reference pointer from the String Constant Pool for duplicate text deduplication."
        }
      ]
    }
  },
  {
    "id": "java-collections",
    "number": "04",
    "category": "2. Strings & Collections",
    "title": "4. Java Collections Framework Masterclass & Internal Mechanics",
    "subtitle": "Complete Architecture of List, Set, Queue, Deque, HashMap Bucket Internals, Treeification, and Concurrent Collections",
    "summary": "Granular breakdown of data structures, dynamic array growth formulas, hash bucket collision resolution, Red-Black Trees, and high-throughput thread-safe collections.",
    "diagramType": "hashmap-treeify",
    "detailedContent": {
      "introduction": "The Java Collections Framework (JCF) is the core foundation for data manipulation in Java. It provides unified data structures divided into two primary root hierarchies: java.util.Collection and java.util.Map. Understanding their internal memory layouts, time complexities, bitwise bucket routing, and concurrency models is essential for enterprise engineering.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          "q": "Why must HashMap initial capacity be a power of 2?",
          "a": "Because power of 2 enables fast bitwise AND index calculation (hash & (n-1)) which is significantly faster than modulo division (hash % n)."
        },
        {
          "q": "Difference between Fail-Fast and Fail-Safe iterators?",
          "a": "Fail-Fast iterators check internal modCount and throw ConcurrentModificationException on structural edits. Fail-Safe iterators iterate over a snapshot copy of the data."
        },
        {
          "q": "Why is ArrayDeque faster than Stack and LinkedList for stack operations?",
          "a": "ArrayDeque stores elements in contiguous memory without allocation of node objects or pointer dereferencing, yielding superior CPU cache locality."
        }
      ]
    }
  },
  {
    ...
    "number": "05",
    "category": "2. Strings & Collections",
    "title": "5. equals() & hashCode() Contract Architecture",
    "subtitle": "Object Equality, Hashing Contracts, and Collision Resolution",
    "summary": "Understanding object identity vs state equality, bucket routing, and hash distribution.",
    "diagramType": "equals-hashcode-flow",
    "detailedContent": {
      "introduction": "In Java, java.lang.Object defines default implementations for equals() and hashCode(). Overriding these methods correctly is essential for storing custom objects inside Hash-based collections (HashMap, HashSet, Hashtable).",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "true",
              "MUST be true",
              "Correct bucket match"
            ],
            [
              "Hash Collision",
              "false",
              "Can be true",
              "Chain in same bucket"
            ],
            [
              "Broken Contract",
              "true",
              "false (Different)",
              "BUG: Lost keys & duplicate entries"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What happens if two different keys have the same hash code?",
          "a": "A hash collision occurs. The HashMap stores both entries in the same bucket chain (LinkedList or Red-Black Tree)."
        },
        {
          "q": "Why use prime numbers like 31 in hashCode() computation?",
          "a": "Prime numbers minimize hash collisions. Multiplication by 31 can be optimized by compilers using bitwise shift: (i << 5) - i."
        }
      ]
    }
  },
  {
    ...
    "number": "06",
    "category": "3. Exceptions & Generics",
    "title": "6. Exception Handling & Robust Error Architecture Masterclass",
    "subtitle": "Throwable Hierarchy, Checked vs Unchecked Exceptions, Stack Unwinding, Try-With-Resources & Enterprise Exception Handler Patterns",
    "summary": "Designing resilient exception propagation, custom domain exceptions, resource leaks prevention, and Spring @ControllerAdvice architectures.",
    ...
    "detailedContent": {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              ...
              "Mandatory (Compile-time check)",
              "Optional (Runtime check)"
            ],
            [
              "Primary Cause",
              "Recoverable environmental/external failures",
              "Programming logic bugs & invalid inputs"
            ],
            [
              "Syntax Declaration",
              "Must use try-catch or throws clause",
      ...
      "interviewQuestions": [
        {
          "q": "What is Suppressed Exception in Try-With-Resources?",
          "a": "When both try block and close() throw exceptions, the close() exception is suppressed and attached to the primary exception payload via e.getSuppressed()."
        },
        {
          "q": "Does finally execute if a return statement is present in try?",
          "a": "Yes. The finally block executes BEFORE the method actually returns the value to the caller."
        },
        {
          "q": "Why are RuntimeExceptions unchecked?",
          "a": "Because checking runtime logic bugs (like NullPointerException or IndexOutOfBounds) everywhere would clutter Java code without providing recoverable remedies."
        }
      ]
    }
  },
  {
    "id": "java-8-functional",
    "number": "07",
    "category": "5. Modern Java (8 to 21+)",
    "title": "7. Java 8+ Functional Programming & Streams API",
    "subtitle": "Lambda Expressions, Functional Interfaces, Stream Pipelines, and Parallel Execution",
    "summary": "Declarative data processing, lazy evaluation, method references, and Collector patterns.",
    "diagramType": "stream-pipeline-flow",
    "detailedContent": {
      "introduction": "Java 8 revolutionized Java development by introducing Functional Programming features alongside Object-Oriented design, enabling declarative data processing with Lambdas and Streams.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          ...
          "a": "map() transforms 1:1 elements; flatMap() flattens 1:N nested streams (Stream<List<T>> ➔ Stream<T>)."
        },
        {
          "q": "Difference between orElse() and orElseGet() in Optional?",
          "a": "orElse(val) evaluates default value eagerly regardless; orElseGet(() -> val) evaluates default value lazily only if empty."
        }
      ]
    }
  },
  {
    ...
    "number": "08",
    "category": "3. Exceptions & Generics",
    "title": "8. Java Generics & PECS Rule",
    "subtitle": "Type Erasure, Wildcards (? extends T vs ? super T), and Covariance/Contravariance",
    "summary": "Compile-time type safety, wildcard bounds, and the Producer Extends Consumer Super rule.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Java Generics (introduced in Java 5) enable classes, interfaces, and methods to be parameterized by type, eliminating manual type casts and catching type errors at compile-time.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Arrays enforce runtime type checks, whereas generic types are erased at compile time, leading to ArrayStoreException risk."
        },
        {
          "q": "What is a Bridge Method in Java Generics?",
          "a": "A synthetic method created by the compiler during type erasure to preserve polymorphic method overriding."
        }
      ]
    }
  },
  {
    ...
    "number": "09",
    "category": "4. Concurrency & JVM",
    "title": "9. Multithreading & Concurrency Essentials Masterclass",
    "subtitle": "Thread Lifecycle, Monitors, Explicit Locks, ThreadPoolExecutor Tuning, Synchronizers, CAS Atomics & CompletableFuture Chains",
    "summary": "Mastering thread state transitions, ReentrantLock, ReadWriteLock, ExecutorService tuning, atomic operations, and async programming.",
    "diagramType": "multithreading-lifecycle",
    "detailedContent": {
      "introduction": "Multithreading enables concurrent execution of multiple threads within a single JVM process, maximizing hardware CPU core utilization. Mastering thread state transitions, synchronization monitors, lock-free CAS atomics, thread pool tuning, and CompletableFuture chains is critical for concurrent server applications.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              "Lock Type",
              "Implicit Intrinsic Monitor",
              "Explicit Lock API",
              "Separate Read/Write Lock API"
            ],
            [
              "Concurrent Readers",
              "Single (Blocked)",
      ...
      "interviewQuestions": [
        {
          "q": "What is Deadlock and how can it be avoided?",
          "a": "Deadlock occurs when 2+ threads wait indefinitely for locks held by each other. Avoid it by acquiring locks in a strict global ordering."
        },
        {
          "q": "Difference between submit() and execute() in ExecutorService?",
          "a": "execute() returns void and uncaught exceptions crash worker threads; submit() returns Future<T> capturing exceptions inside Future.get()."
        },
        {
          "q": "Why is LongAdder faster than AtomicLong under high thread contention?",
          "a": "LongAdder splits internal counters across multiple cells per CPU core, reducing CAS bus contention."
        }
      ]
    }
  },
  {
    ...
    "number": "10",
    "category": "4. Concurrency & JVM",
    "title": "10. JVM Architecture & ClassLoader Subsystem",
    "subtitle": "ClassLoader Delegation Hierarchy, Memory Areas, and Execution Engine",
    "summary": "Deep dive into HotSpot JVM runtime data areas, Metaspace, and JIT compiler tiers.",
    "diagramType": "jvm-memory-flow",
    "detailedContent": {
      "introduction": "The HotSpot JVM is an enterprise-grade virtual machine that executes Java bytecode, providing automatic memory management, dynamic tier compilation, and hardware abstracting.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Metaspace replaced PermGen in Java 8. Metaspace resides in off-heap native memory and auto-resizes dynamically."
        },
        {
          "q": "What is Escape Analysis in JIT Compiler?",
          "a": "Escape Analysis determines if an object allocation escapes a method context. If not, JIT optimizes allocation onto the Stack (Scalar Replacement) instead of Heap!"
        }
      ]
    }
  },
  {
    ...
    "number": "11",
    "category": "4. Concurrency & JVM",
    "title": "11. Garbage Collection Mechanics & Collectors",
    "subtitle": "Generational GC Hypothesis, Mark-Sweep-Compact, G1GC, ZGC, and GC Tuning",
    "summary": "Automated memory reclamation, pause time minimization, and collector selection strategy.",
    "diagramType": "gc-regions",
    "detailedContent": {
      "introduction": "Java Garbage Collection (GC) automatically reclaims Heap memory occupied by unreferenced objects, eliminating manual memory deallocation bugs.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              "G1GC",
              "Balanced Throughput & Pause Time",
              "Low (100-200ms target)",
              "4 GB - 64 GB"
            ],
            [
              "ZGC",
      ...
      "interviewQuestions": [
        {
          "q": "What are GC Roots?",
          "a": "Objects directly accessible from outside the Heap (Thread stack frames, local variables, active static fields, JNI native pointers)."
        },
        {
          "q": "Difference between Minor GC, Major GC, and Full GC?",
          "a": "Minor GC collects Young Gen; Major GC collects Old Gen; Full GC collects entire Heap + Metaspace in Stop-The-World pause."
        }
      ]
    }
  },
  {
    ...
    "number": "12",
    "category": "4. Concurrency & JVM",
    "title": "12. Java Memory Model (JMM) & Happens-Before",
    "subtitle": "CPU Caching, Instruction Reordering, Volatile Barriers, and Atomic Operations",
    "summary": "Mastering thread visibility guarantees, memory barriers, and lock-free CAS atomics.",
    "diagramType": "jmm-cache-coherence",
    "detailedContent": {
      "introduction": "The Java Memory Model (JMM) defines formal rules specifying how threads interact through shared memory, guaranteeing visibility, ordering, and atomicity.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          "q": "What is False Sharing in JVM memory access?",
          "a": "False Sharing occurs when threads on different CPU cores modify independent variables residing on the same 64-byte hardware Cache Line."
        },
        {
          "q": "What is the Happens-Before guarantee?",
          "a": "A formal JMM ordering relationship guaranteeing that memory updates made by Action A are visible to Action B."
        }
      ]
    }
  },
  {
    ...
    "number": "13",
    "category": "1. Fundamentals & OOP",
    "title": "13. Interfaces vs Abstract Classes",
    "subtitle": "Architectural Contract vs Inheritance Blueprint, Default Methods, and Multiple Interface Resolution",
    "summary": "Comparing abstract class state inheritance against interface component contract modularity.",
    "diagramType": "interface-abstract-tree",
    "detailedContent": {
      "introduction": "Abstract Classes and Interfaces form the backbone of abstraction in Java, allowing developers to define contracts and reusability.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              "Inheritance Model",
              "Multiple implementation (implements A, B)",
              "Single inheritance (extends A)"
            ],
            [
              "Instance Fields",
              "Forbidden (Only public static final constants)",
              "Allowed (private, protected, instance fields)"
            ],
            [
              "Constructors",
              "Forbidden",
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Yes. An interface can extend multiple parent interfaces using the extends keyword."
        },
        {
          "q": "Why can't interfaces have constructors?",
          "a": "Constructors initialize instance state. Since interfaces cannot possess instance state fields, constructors are prohibited."
        }
      ]
    }
  },
  {
    "id": "access-modifiers-lifecycle",
    "number": "14",
    "category": "1. Fundamentals & OOP",
    "title": "14. Access Modifiers & Object Lifecycle",
    "subtitle": "Visibility Scope Matrix, Initializer Blocks, and Memory Lifecycle",
    "summary": "Mastering public, protected, package-private, private visibility and object instantiation steps.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Access modifiers enforce encapsulation boundaries across classes, packages, and subclasses.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          "q": "Can a class be declared private or protected?",
          "a": "Top-level classes CANNOT be private or protected (only public or package-private). Inner nested classes CAN be private/protected."
        },
        {
          "q": "What is a Blank Final variable?",
          "a": "A final instance variable not initialized at declaration; it MUST be initialized in every constructor."
        }
      ]
    }
  },
  {
    ...
    "number": "15",
    "category": "1. Fundamentals & OOP",
    "title": "15. Immutability & Defensive Copying",
    "subtitle": "Rules of Immutability, Defensive Copies, and Thread Safety",
    "summary": "Building robust unmodifiable objects and preventing reference leakage.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Immutable objects cannot be modified after creation, offering thread safety without locking.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              "HashMap Key Suitability",
              "Dangerous (Hash mutation)",
              "Ideal & Safe"
            ],
            [
              "Defensive Copy Requirement",
              "Not required",
              "Mandatory for internal reference fields"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Because if key state mutates, its hashCode changes, making the entry unlocatable in the HashMap bucket."
        },
        {
          "q": "Are Java 16 Records automatically immutable?",
          "a": "Yes. Records create final fields and private components, but mutable fields (e.g. Date/List) inside records still require manual defensive copies in compact constructors!"
        }
      ]
    }
  },
  {
    ...
    "number": "16",
    "category": "5. Modern Java (8 to 21+)",
    "title": "16. Java Records (Java 16+)",
    "subtitle": "Transparent Data Carriers, Compact Constructors, and Pattern Matching Integration",
    "summary": "Replacing verbose boilerplate POJOs with immutable record data carriers.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Java Records (introduced in Java 16) are special immutable data classes designed to act as transparent carriers for immutable data payloads.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "headers": [
            "Feature",
            "Traditional POJO Class",
            "Java Record (Java 16+)"
          ],
          "rows": [
            [
              "Boilerplate Code",
              "High (Getters, equals, hashCode, toString)",
              "Zero (Auto-generated by compiler)"
            ],
            [
              "Field Mutability",
              "Mutable by default",
              "Strictly Immutable (final fields)"
            ],
            [
              "Inheritance",
              "Can extend classes",
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Yes. Records can implement one or multiple interfaces."
        },
        {
          "q": "Can record accessor methods be overridden?",
          "a": "Yes, component accessor methods can be overridden, but they should preserve the original component contract."
        }
      ]
    }
  },
  {
    ...
    "number": "17",
    "category": "1. Fundamentals & OOP",
    "title": "17. Enums & High-Performance Collections",
    "subtitle": "Type-Safe Constants, Enum Class Under the Hood, EnumSet, and EnumMap",
    "summary": "Type-safe enumerations, Singleton pattern guarantee, and bitwise collection optimization.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Enums represent fixed set of type-safe constants, implicitly extending java.lang.Enum.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              ...
              "Compact Array (Indexed by ordinal)",
              "Bucket Array + Red-Black Tree"
            ],
            [
              "Performance",
              "Fastest O(1) (Direct array access)",
              "O(1) average / O(log N) treeified"
            ],
            [
              "Memory Footprint",
              "Minimal array storage",
              "Node objects & bucket overhead"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          ...
          "a": "No. Enums implicitly extend java.lang.Enum, and Java does not support multiple class inheritance."
        },
        {
          "q": "Why is EnumSet faster than HashSet?",
          "a": "Because EnumSet uses bitwise bitmask operations on primitive long integers internally."
        }
      ]
    }
  },
  {
    ...
    "number": "18",
    "category": "5. Modern Java (8 to 21+)",
    "title": "18. Annotations & Reflection API",
    "subtitle": "Metadata Annotations, Runtime Reflection, Proxies, and Reflection Performance Costs",
    "summary": "Inspecting runtime bytecode, custom annotations, dynamic proxies, and security limits.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Annotations provide metadata information about code, processed at compile-time or runtime via Reflection.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "No",
              "No",
              "Lombok, @Override, Compiler Warnings"
            ],
            [
              "CLASS",
              "Yes",
              "No",
              "Bytecode enhancement tools"
            ],
            [
              "RUNTIME",
              "Yes",
              "Yes",
              "Spring IoC, Jackson JSON, JUnit"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What is MethodHandle in Java?",
          "a": "Introduced in Java 7, MethodHandle is a low-level, strongly-typed executable method reference faster than standard Reflection."
        },
        {
          "q": "Difference between Class.forName() and ClassLoader.loadClass()?",
          "a": "Class.forName() initializes static blocks by default; ClassLoader.loadClass() delays static initialization until first instantiation."
        }
      ]
    }
  },
  {
    "id": "java-io-nio",
    "number": "19",
    "category": "6. Frameworks & Enterprise",
    "title": "19. Traditional I/O vs Modern Java NIO",
    "subtitle": "Stream I/O vs Buffer/Channel NIO, Non-blocking Selectors, and Memory-Mapped Files",
    "summary": "Blocking byte streams vs non-blocking channel selectors, direct buffers, and zero-copy performance.",
    "diagramType": "nio-channel-buffer",
    "detailedContent": {
      "introduction": "Java NIO (New I/O) provides non-blocking, high-performance channel buffer I/O operations for enterprise server scalability.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "Buffer-Oriented (Block of data)"
            ],
            [
              "Threading Model",
              "Blocking (1 Thread per Connection)",
              "Non-blocking (1 Selector Thread for N Connections)"
            ],
            [
              "Direct Memory",
              "Heap memory buffers only",
              "Direct Off-Heap Native Memory Support"
            ],
            [
              "Zero-Copy Support",
              "No",
              "Yes (FileChannel.transferTo())"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What does ByteBuffer.flip() do?",
          "a": "flip() flips a buffer from writing mode to reading mode by setting limit = position and resetting position = 0."
        },
        {
          "q": "Difference between HeapByteBuffer and DirectByteBuffer?",
          "a": "HeapByteBuffer resides on JVM Heap; DirectByteBuffer allocates native off-heap memory via OS malloc."
        }
      ]
    }
  },
  {
    "id": "serialization-deep-dive",
    "number": "20",
    "category": "6. Frameworks & Enterprise",
    "title": "20. Serialization & Transient Fields",
    "subtitle": "Object Streams, serialVersionUID Versioning, Transient Keyword, and Security Vulnerabilities",
    "summary": "Java binary object serialization mechanics, transient fields, and modern replacement formats.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Serialization converts object graphs into byte streams for file storage or network transmission.",
      "subsections": [
        {
      ...
      "interviewQuestions": [
        {
          "q": "What is readResolve() method used for in Serialization?",
          "a": "readResolve() replaces the deserialized instance with a canonical instance, preserving Singleton invariants."
        },
        {
          "q": "Is constructor invoked during deserialization?",
          "a": "No. For Serializable classes, memory is allocated directly without calling class constructors (only non-serializable superclass no-arg constructor runs)."
        }
      ]
    }
  },
  {
    ...
    "number": "21",
    "category": "5. Modern Java (8 to 21+)",
    "title": "21. Modern Date & Time API (java.time)",
    "subtitle": "Immutability, LocalDate, LocalTime, ZonedDateTime, Instant, and Period vs Duration",
    "summary": "Replacing legacy thread-unsafe java.util.Date with ISO-8601 java.time domain models.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Java 8 introduced java.time (JSR-310) to replace legacy Date and Calendar classes.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              "Time Zone Support",
              "Confounded inside Date",
              "Explicit (ZoneId / ZonedDateTime)"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "How to convert java.util.Date to java.time.Instant?",
          "a": "date.toInstant() returns an Instant aligned with system Epoch."
        },
        {
          "q": "What is ZoneOffset vs ZoneId?",
          "a": "ZoneOffset represents fixed UTC offset (+05:30); ZoneId includes daylight saving rules (Asia/Kolkata)."
        }
      ]
    }
  },
  {
    ...
    "number": "22",
    "category": "6. Frameworks & Enterprise",
    "title": "22. Networking & Modern HTTP Client",
    "subtitle": "Sockets, TCP vs UDP, and Modern HttpClient (Java 11+)",
    "summary": "Low-level socket programming and high-level async HTTP/2 web communication.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "Java networking spans low-level Sockets to high-level async HTTP client communication.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            ...
            [
              "Body Processing",
              "Manual Stream copying",
              "Reactive BodyHandlers"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "Difference between TCP and UDP sockets?",
          "a": "TCP is connection-oriented and reliable with packet ordering; UDP is connectionless, unacknowledged, and ultra-fast."
        },
        {
          "q": "How does HTTP/2 Multiplexing work in Java 11 HttpClient?",
          "a": "HTTP/2 multiplexes multiple request/response streams concurrently over a single underlying TCP connection."
        }
      ]
    }
  },
  {
    ...
    "number": "23",
    "category": "6. Frameworks & Enterprise",
    "title": "23. JDBC Architecture & Connection Pooling",
    "subtitle": "Driver Architecture, PreparedStatement, Transactions, and HikariCP Pooling",
    "summary": "Relational database connectivity, SQL injection prevention, transaction isolation, and HikariCP.",
    "diagramType": "jdbc-hikari-pool",
    "detailedContent": {
      "introduction": "JDBC (Java Database Connectivity) is the standard Java API for executing SQL statements against relational databases.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              "SQL Compilation",
              "Compiled on every execution",
              "Pre-compiled once on DB server"
            ],
            [
              "SQL Injection Risk",
              "HIGH (Vulnerable to string concatenation)",
              "SECURE (Parameter placeholder binding)"
            ],
            [
              "Performance",
              "Slower for repeated queries",
              "Fast (Reuses DB query execution plan)"
            ],
            [
              "Binary Payload Support",
              "No",
              "Supports setBytes() / setBlob()"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What is Dirty Read in Database Transactions?",
          "a": "A Dirty Read occurs when Transaction A reads uncommitted data written by Transaction B that subsequently rolls back."
        },
        {
          "q": "Why is HikariCP faster than legacy pools like C3P0?",
          "a": "HikariCP uses bytecode generation, custom FastList array structures, and lock-free ConcurrentBag thread borrowing."
        }
      ]
    }
  },
  {
    ...
    "number": "24",
    "category": "5. Modern Java (8 to 21+)",
    "title": "24. Modern Java Features Masterclass (Java 17 & Java 21+)",
    "subtitle": "Sealed Classes, Pattern Matching, Record Patterns, Virtual Threads (Project Loom) & Sequenced Collections",
    "summary": "Next-generation Java features from LTS releases 17 and 21 including Project Loom M:N scheduler mechanics.",
    "diagramType": "virtual-threads-flow",
    "detailedContent": {
      "introduction": "Java 17 and 21 introduced game-changing architectural features including Sealed Class domain hierarchies, Pattern Matching for Switch, Record Pattern Deconstruction, Sequenced Collections, and Virtual Threads (Project Loom).",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "JVM (User-Mode Scheduling)"
            ],
            [
              "Memory Footprint",
              "High (~1 MB Stack per Thread)",
              "Ultra-Low (~x hundred Bytes on Heap)"
            ],
            [
              "Creation Limit",
              "Thousands (~2,000-5,000)",
              "Millions (1,000,000+)"
            ],
            [
              "I/O Blocking Cost",
              "High (Blocks OS Thread)",
              "Zero (Unmounts stack from OS thread)"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          ...
          "a": "Pinning occurs when a Virtual Thread executes inside a synchronized block or native method, preventing JVM from unmounting it from the OS carrier thread."
        },
        {
          "q": "How to launch a Virtual Thread in Java 21?",
          "a": "Thread.ofVirtual().start(() -> { /* task */ }); or Executors.newVirtualThreadPerTaskExecutor()."
        }
      ]
    }
  },
  {
    ...
    "number": "25",
    "category": "6. Frameworks & Enterprise",
    "title": "25. Design Patterns & SOLID Architectural Principles",
    "subtitle": "Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion, and GoF Patterns",
    "summary": "Production software design principles and GoF creational, structural, and behavioral patterns.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "SOLID principles and Gang of Four (GoF) design patterns provide proven architectural templates for building resilient enterprise applications.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              ...
              "High cohesion & modularity"
            ],
            [
              "Open / Closed",
              "OCP",
              "Extend via abstractions",
            ...
            [
              ...
              "Loose coupling & easy unit testing"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "Difference between Strategy and State Design Pattern?",
          "a": "Strategy encapsulates independent algorithms chosen by client; State alters object behavior automatically as internal state transitions."
        },
        {
          "q": "How does Spring Framework implement Dependency Inversion?",
          "a": "Spring IoC container instantiates objects and injects dependencies via constructors or fields (@Autowired)."
        }
      ]
    }
  },
  {
    ...
    "number": "26",
    "category": "6. Frameworks & Enterprise",
    "title": "26. Spring Boot & Enterprise Microservices",
    "subtitle": "Spring IoC Container, Bean Lifecycle, Auto-Configuration, Spring Data JPA, and Transactional Management",
    "summary": "Enterprise microservices development, dependency injection, auto-configuration, and AOP proxies.",
    "diagramType": "spring-bean-lifecycle",
    "detailedContent": {
      "introduction": "Spring Boot simplifies enterprise Java application development through Opinionated Auto-Configuration and Dependency Injection.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              "Singleton (Default)",
              "1 per Spring Container",
              "Application Lifetime",
              "Must be stateless / Thread-Safe"
            ],
            [
              "Prototype",
              "1 per Injection request",
              "Destroyed by garbage collector",
              "Caller handles thread safety"
            ],
            [
              "Request",
              "1 per HTTP Request",
              "Duration of single HTTP request",
              "Thread-safe (Request bound)"
            ],
            [
              "Session",
              "1 per HTTP Session",
              "Duration of HTTP User Session",
              "Thread-safe (Session bound)"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What is Circular Dependency in Spring and how is it resolved?",
          "a": "Occurs when Bean A requires Bean B and Bean B requires Bean A. Resolved using @Lazy injection or refactoring class responsibilities."
        },
        {
          "q": "Difference between @Component, @Service, and @Repository?",
          "a": "All are stereotype annotations registering Spring beans. @Repository additionally translates native DB exceptions into Spring DataAccessExceptions."
        }
      ]
    }
  },
  {
    ...
    "number": "27",
    "category": "7. Senior Interview Bank",
    "title": "27. Senior Java Interview Follow-Up Question Trees",
    "subtitle": "Architectural Scenarios, Memory Tuning Deep Dives, Concurrency Debugging, and System Failure Cases",
    "summary": "Senior engineering interview question trees, trade-off evaluations, and debugging production edge cases.",
    "diagramType": null,
    "detailedContent": {
      "introduction": "This section provides senior-level interview follow-up question trees, designed to test deep architectural understanding and production debugging skills.",
      "subsections": [
        {
      ...
      "tables": [
        {
          ...
          "rows": [
            [
              "Language Depth",
              "Knows syntax & basic API usage",
              "Understands JVM internals, bytecode, JMM & Memory Barriers"
            ],
            [
              "Concurrency",
              "Can start threads & use synchronized",
              "Understands CAS, lock-free algorithms, Thread Pools & Virtual Threads"
            ],
            [
              "Architecture",
              "Implements basic CRUD endpoints",
              "Designs resilient, loosely-coupled SOLID microservices with trade-offs"
            ],
            [
              "Debugging",
              "Uses System.out.println & basic IDE breakpoints",
              "Analyzes heap dumps, thread dumps, GC logs & JFR profiles"
            ]
          ]
        }
      ],
      ...
      "interviewQuestions": [
        {
          "q": "What is JDK Flight Recorder (JFR)?",
          "a": "JFR is an event-based profiling framework built directly into the HotSpot JVM that collects low-overhead (<1%) CPU, memory, and thread diagnostic data."
        },
        {
          "q": "How to prevent thread starvation in ThreadPoolExecutor?",
          "a": "Use caller runs rejection policies or bounded queues with monitored rejection handlers, and isolate heavy blocking I/O tasks into dedicated thread pools."
        }
      ]
    }
  }
