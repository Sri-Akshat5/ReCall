      ...
      <div className="p-5 sm:p-8 rounded-3xl bg-white border border-slate-200 dark:bg-zinc-950 dark:border-zinc-800 space-y-4    relative overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-slate-700 dark:bg-zinc-900 dark:border-zinc-800 text-xs font-mono dark:text-zinc-300">
            ...
            <span>Master Java Collections Framework (JCF) 33 Individual Textbook Modules</span>
          </div>
        </div>

        <div className="space-y-2">
          <h1 className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            Java Collections Framework (JCF) Complete Master Modules
          </h1>
          <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 max-w-3xl leading-relaxed">
            33 Individual modules covering Array Limitations, Collection Hierarchy, Collection/Iterator/List/Queue/Deque/Map/Entry methods, ArrayList, LinkedList, HashSet, LinkedHashSet, TreeSet, PriorityQueue, ArrayDeque, HashMap, LinkedHashMap, TreeMap, Hashtable, EnumSet, EnumMap, Collections Utilities, Comparable vs Comparator, and ArrayList vs Vector.
          </p>
        </div>
        ...
        <div className="pt-2 space-y-3">
          ...
          <div className="max-w-md relative">
            <input
              type="text"
              placeholder="Search 33 Modules (e.g. ArrayList, HashMap, EnumSet, Comparator)..."
              value={searchQuery}
